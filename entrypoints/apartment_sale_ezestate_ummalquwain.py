...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_ezestate_ummalquwain")
...
setup_crawler('Websites//ApartmentSale//EzestateUmmAlQuwain//Items.xml')
#log.start()
reactor.run()