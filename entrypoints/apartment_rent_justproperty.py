...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_justproperty")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_justproperty.log")
...
setup_crawler('Websites//ApartmentRent//JustProperty//Items.xml')
#log.start()
reactor.run()