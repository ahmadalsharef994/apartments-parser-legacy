...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_yzeproperty")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_yzeproperty.log")
...
setup_crawler('Websites//ApartmentRent//Yzerproperty//Items.xml')
#log.start()
reactor.run()