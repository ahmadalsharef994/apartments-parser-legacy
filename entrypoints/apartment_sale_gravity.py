...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_gravity")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/seen_apartment_sale_gravity.log")
...
setup_crawler('Websites//ApartmentSale//Gravity//Items.xml')
#log.start()
reactor.run()