...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_ezestate_sharjah")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/apartments_sale_ezestate_sharjah.log")
...
setup_crawler('Websites//ApartmentSale//EzestateSharjah//Items.xml')
#log.start()
reactor.run()