...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_dubizzle")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/apartments_sale_dubizzle.log")
...
setup_crawler('Websites//ApartmentSale//Dubizzle//Items.xml')
# log.start()
reactor.run()