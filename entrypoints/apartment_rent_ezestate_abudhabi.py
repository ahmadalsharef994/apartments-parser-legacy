...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_ezestate_abudhabi")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_ezestate_abudhabi.log")
...
setup_crawler('Websites//ApartmentRent//EzestateAbudhabi//Items.xml')
#log.start()
reactor.run()