...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_ezestate_rasalkhaima")
...
setup_crawler('Websites//ApartmentSale//EzestateRasAlKhaimah//Items.xml')
#log.start()
reactor.run()