...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_ezestate_dubai")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/apartments_sale_ezestate_dubai.log")
...
setup_crawler('Websites//ApartmentSale//EzestateDubai//Items.xml')
#log.start()
reactor.run()