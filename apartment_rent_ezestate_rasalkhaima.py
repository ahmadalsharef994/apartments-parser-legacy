...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_ezestate_rasalkhaimah")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_ezestate_rasalkhaimah.log")
...
setup_crawler('Websites//ApartmentRent//EzestateRasAlKhaimah//Items.xml')
#log.start()
reactor.run()