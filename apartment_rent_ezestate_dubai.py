...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_ezestate_dubai")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_ezestate_dubai.log")
...
setup_crawler('Websites//ApartmentRent//EzestateDubai//Items.xml')
#log.start()
reactor.run()