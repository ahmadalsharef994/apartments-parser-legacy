...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_propsearch")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_propsearch.log")
...
setup_crawler('Websites//ApartmentRent//Propsearch//Items.xml')
#log.start()
reactor.run()