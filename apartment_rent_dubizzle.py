...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_dubizzle")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_dubizzle.log")
...
setup_crawler('Websites//ApartmentRent//Dubizzle//Items.xml')
#log.start()
reactor.run()