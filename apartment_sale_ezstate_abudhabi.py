...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_Sale_ezestate_abudhabi")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/apartments_sale_ezestate_abudhabi.log")
...
setup_crawler('Websites//ApartmentSale//EzestateAbudhabi//Items.xml')
#log.start()
reactor.run()