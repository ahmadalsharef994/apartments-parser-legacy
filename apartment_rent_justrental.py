...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_justrentals")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_justrentals.log")
...
setup_crawler('Websites//ApartmentRent//JustRentals//Items.xml')
#log.start()
reactor.run()