...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_justproperty")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Sale/apartments_sale_justproperty.log")
...
setup_crawler('Websites//ApartmentSale//JustProperty//Items.xml')
#log.start()
reactor.run()