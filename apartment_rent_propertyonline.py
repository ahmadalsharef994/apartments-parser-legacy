...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_propertyonline")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_propertyonline.log")
...
setup_crawler('Websites//ApartmentRent//PropertyOnline//Items.xml')
#log.start()
reactor.run()