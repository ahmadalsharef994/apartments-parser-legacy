...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Rent/seen_apartment_rent_ezestate_ajman")
    Settings.set(settings, 'LOG_FILE', "LogFiles/Apartment/Rent/apartments_rent_ezestate_ajman.log")
...
setup_crawler('Websites//ApartmentRent//EzestateAjman//Items.xml')
#log.start()
reactor.run()