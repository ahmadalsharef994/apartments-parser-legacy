...
def setup_crawler(domain):
    ...
    Settings.set(settings, 'JOBDIR', "SeenFolders/Apartment/Sale/seen_apartment_sale_ezestate_ajman")
...
setup_crawler('Websites//ApartmentSale//EzestateAjman//Items.xml')
#log.start()
reactor.run()